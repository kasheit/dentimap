...
export function SearchPalette({ open, onClose }: { open: boolean; onClose: () => void }) {
  ...
  return (
    <div className="animate-fade-in fixed inset-0 z-[60] flex items-start justify-center bg-black/70 px-4 pt-[12vh]" onMouseDown={onClose} role="dialog" aria-label="Search">
      <div className="animate-scale-in w-full max-w-xl origin-top overflow-hidden rounded-lg border border-dm-border bg-dm-surface shadow-xl shadow-black/60" onMouseDown={(e) => e.stopPropagation()} onKeyDown={onKeyDown}>
