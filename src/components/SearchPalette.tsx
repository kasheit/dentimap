...
export function SearchPalette({ open, onClose }: { open: boolean; onClose: () => void }) {
  ...
  return (
    <div className="fixed inset-0 z-[60] flex items-start justify-center bg-black/60 px-4 pt-[12vh]" onMouseDown={onClose} role="dialog" aria-label="Search">
      <div className="w-full max-w-xl overflow-hidden rounded-xl border border-dm-border bg-dm-surface shadow-2xl shadow-black/60" onMouseDown={(e) => e.stopPropagation()} onKeyDown={onKeyDown}>
