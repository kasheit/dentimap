...
export function ConfirmLabel({ property, field, label, has, extra }: { property: Property; field: SourcedField; label: string; has: boolean; extra?: React.ReactNode }) {
  ...
  return (
    <span className="relative inline-block">
      ...
      {open && (
        <span className="absolute right-0 top-full z-20 mt-2 grid w-[min(32rem,88vw)] gap-2 rounded-md border border-dm-border bg-dm-surface p-3 text-left shadow-xl shadow-black/50 sm:grid-cols-[1fr_9rem_auto]">
