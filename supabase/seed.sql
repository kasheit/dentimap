...
-- Payer mix and staffing notes are reported organization-wide for VFD (not
-- location-specific), so they're repeated identically across all 6 VFD rows;
-- nothing has been reported for Valleygate, so those stay empty.
...
insert into public.locations
  (record_id, name, city, state, asset_type, specialty, date_established, operating_footprint_sq_ft,
   ...
   current_asset_valuation, status, description, payer_mix, staffing_notes)
values
  ('VFD-001', 'St. Pauls', 'St. Pauls', 'NC', 'dental', array['General'],
  ...
  ('VFD-003', 'Fayetteville', 'Fayetteville', 'NC', 'dental', array['General'],
  ...
  ('VFD-004', 'Eastover', 'Eastover', 'NC', 'dental', array['General'],
  ...
  ('VFD-005', 'Raeford', 'Raeford', 'NC', 'dental', array['General'],
  ...
  ('VFD-006', 'Laurinburg', 'Laurinburg', 'NC', 'dental', array['General'],
  ...
  ('VG-001', 'Fayetteville', 'Fayetteville', 'NC', 'asc', array['OMFS', 'General'],
  ...
  ('VG-002', 'Triad (Greensboro)', 'Greensboro', 'NC', 'asc', array['OMFS'],
  ...
  ('VG-003', 'The West', 'Unconfirmed', 'NC', 'asc', array['OMFS'],
  ...
  ('VG-004', 'Garner', 'Garner', 'NC', 'asc', array['OMFS', 'General'],
  ...
  ('VG-005', 'S. Charlotte', 'Charlotte', 'NC', 'asc', array['OMFS'],
